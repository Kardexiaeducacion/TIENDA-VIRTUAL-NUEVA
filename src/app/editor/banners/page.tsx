            ...
            <form onSubmit={handleSave} className="p-6 flex flex-col gap-5">
              ...
              <div className="flex gap-3 justify-end mt-4">
                <button 
                  ...
                  className="px-6 py-3 border border-gray-300 text-gray-700 text-sm font-bold uppercase rounded hover:bg-gray-50 transition-colors"
                >
                  Cancelar
                </button>
                <button 
                  type="submit"
                  className="px-6 py-3 bg-black text-white text-sm font-bold uppercase rounded hover:bg-gray-800 transition-colors"
                >
                  Guardar Cambios
                </button>
              </div>
